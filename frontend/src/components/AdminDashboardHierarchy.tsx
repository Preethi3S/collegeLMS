...
export const AdminDashboardHierarchy: React.FC<Props> = ({ selectedCourseId }) => {
  ...
  const fetchHierarchyData = async () => {
    try {
      ...
      const yearMap = new Map<string, Map<string, Student[]>>();
      ...
      const hierarchyData: YearData[] = years.map(year => ({
        year,
                              ...
                              <List sx={{ p: 0 }}>
                                {deptData.students.map(student => (
                                  ...
                                  >
                                    <Avatar
                                      src={student.avatar}
                                      sx={{ width: 32, height: 32, mr: 1.5, bgcolor: 'primary.light' }}
                                    >
                                      {student.firstName[0]}
                                    </Avatar>
                                    <ListItemText
...
export default AdminDashboardHierarchy;
